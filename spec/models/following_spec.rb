...
RSpec.describe Following, type: :model do
    before :each do
        @user = User.create(name: 'aldana', email: 'aldu000@gmail.com', password: '123456', password_confirmation: '123456')
        @user2 = User.create(name: 'aldulonghijaja', email: 'aldulonghijaja@gmail.com', password: '123456', password_confirmation: '123456')
